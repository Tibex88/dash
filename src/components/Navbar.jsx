...
import { refreshVirtualFrozenRows } from '@syncfusion/ej2-react-grids';
  ...
  return (
    ...
    >
      ...
      position="BottomCenter">
        <div
        className='flex item-canter gap-2 cursor-pointer hover:bg-light-gray'
        onClick={()=>handleClick("userProfile")}>
            ...
            <p className="text-gray-400">
              <span>Hi,</span>{' '}
              <span className="text-gray-400 font-bold ml-1 text-14">Tibebe</span>
            </p>
            <MdKeyboardArrowDown
